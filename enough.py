...
███████████████████████████
    ...
    Sms: {}           {}Telegram {}@whiteniggee\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- Send SMS \n\n 2- Turbo SMS \n\n 3- Exit\n\n" + Fore.LIGHTYELLOW_EX + " Vote: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "You have logged in incorrectly. Try again.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Please write the phone number without '+49' at the beginning. (If there is more than one, press 'enter'): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
            ...
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Invalid phone number. Try again.") 
                sleep(3)
                continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Email address (If you don't know, press 'enter'): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Invalid email address. Try again.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + f"How many SMS do you want to send? {sonsuz}: "+ Fore.LIGHTGREEN_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "How many seconds apart do you want to send?: "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "You have logged in incorrectly. Try again.") 
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Exit in progress...")
        break
    elif menu == 2:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Please write the phone number without '+49' at the beginning.: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 11:
        ...
        try:
            ...
            system("cls||clear")
            print("\nCtrl+C Key combination detected. Returning to menu..")
            sleep(2)
